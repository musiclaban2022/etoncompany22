...
class AppStateNotifier extends ChangeNotifier {
  EtonFirebaseUser? initialUser;
  EtonFirebaseUser? user;
  ...
  void update(EtonFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'shareqr',
              path: 'shareqr',
              builder: (context, params) => ShareqrWidget(),
            ),
            FFRoute(
              name: 'plansdfghj',
              path: 'plansdfghj',
              builder: (context, params) => PlansdfghjWidget(),
            )
